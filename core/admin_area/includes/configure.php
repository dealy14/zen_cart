...
// Define the webserver and path parameters
  ...
  define('HTTP_CATALOG_SERVER', 'http://cosmosconsultingllc.com');
  define('HTTPS_CATALOG_SERVER', 'https://cosmosconsultingllc.com');
...
// * DIR_WS_* = Webserver directories (virtual/URL)
  ...
  define('DIR_WS_ADMIN', '/shopping_cart/admin_area/');
  define('DIR_WS_CATALOG', '/shopping_cart/');
  define('DIR_WS_HTTPS_ADMIN', '/shopping_cart/admin_area/');
